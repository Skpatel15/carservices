...
<head>
    ...
    $serviceData = array(); // Initialize an array to store the fetched data

    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            // Add each row to the $serviceData array
            $serviceData[] = $row;
        }
    } else {
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                <th style="width:80px;"><strong>S N</strong></th>
                                                <th><strong>Name</strong></th>
                                                <th><strong>Email</strong></th>
                                                <th><strong>Service Type</strong></th>
                                                <th><strong>Service.Date</strong></th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($serviceData)) {
                                                foreach ($serviceData as $key => $row) { ?>
                                                    <tr>
                                                        ...
                                                        if ($row['status'] == "PENDING") { ?>
                                                            <td><span class="badge light badge-warning openModalBtn" data-service_id="<?= $row['id']; ?>"><?= $row['status']; ?></span></td>
                                                        <?php } else if ($row['status'] == "INPROGRESS") { ?>
                                                            <td><span class="badge light badge-info openModalBtn" data-service_id="<?= $row['id']; ?>"><?= $row['status']; ?></span></td>
                                                        <?php } elseif ($row['status'] == "COMPLETED") { ?>
                                                            <td><span class="badge light badge-success openModalBtn" data-service_id="<?= $row['id']; ?>"><?= $row['status']; ?></span></td>
                                                        <?php } ?>
                                                        <td><?= $row['remark']; ?></td>
                                                    </tr>
                                            <?php }
                    ...
                    <form action="change_status.php" method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status" id="statusSelect">
